...
private:
    ...
    void print_connected_components() {
        ...
        if(components.size() > 1){
            cout << "\n[KRUSKAL] Suggested edges to connect components:\n";
    ...
    void optimization_engine() {
        ...
        if(cnt != m.size()-1){
            cout << "\n[KRUSKAL] Graph is NOT fully connected.\n";
            cout << "[KRUSKAL] Minimum Spanning Forest generated.\n";
